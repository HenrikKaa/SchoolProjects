...
directive set /dct/core/MAC -PIPELINE_INIT_INTERVAL 0
directive set /dct/core/vert -PIPELINE_INIT_INTERVAL 1
directive set /dct/core/hor -PIPELINE_INIT_INTERVAL 1
directive set /dct/core/MAC -UNROLL yes
directive set /dct/core/MAC#1 -UNROLL yes
directive set /dct/core/main -PIPELINE_INIT_INTERVAL 8
directive set /dct/core/copy_input -UNROLL yes
directive set /dct/core/vert_mac -UNROLL yes
directive set /dct/core/copy_mem -UNROLL yes
directive set /dct/core/hor_mac -UNROLL yes
go architect
go extract
