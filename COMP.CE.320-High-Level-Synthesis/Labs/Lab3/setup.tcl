...
directive set /mult_add/core -DESIGN_GOAL Latency
directive set /mult_add/data:rsc -MAP_TO_MODULE ccs_ioport.ccs_in_wait
directive set /mult_add/coeff:rsc -MAP_TO_MODULE ccs_ioport.ccs_in_wait
directive set /mult_add/return:rsc -MAP_TO_MODULE ccs_ioport.ccs_out_wait
