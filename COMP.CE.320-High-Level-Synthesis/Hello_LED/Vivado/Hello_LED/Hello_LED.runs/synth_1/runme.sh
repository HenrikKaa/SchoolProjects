...
HD_PWD='P:/HLS/Hello_LED/Vivado/Hello_LED/Hello_LED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Hello_LED_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Hello_LED_wrapper.tcl
