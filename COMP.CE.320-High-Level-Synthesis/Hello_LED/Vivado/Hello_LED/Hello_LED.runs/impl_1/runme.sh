...
HD_PWD='P:/HLS/Hello_LED/Vivado/Hello_LED/Hello_LED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Hello_LED_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Hello_LED_wrapper.tcl -notrace
