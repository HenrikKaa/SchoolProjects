...
void compare_results(hls_result_t HLS[N][N], result_t CPP[N][N], int expect_difference=0) {
    int error = 0;
    int once = 0;   // Used for printing negative test result
