...
--
-- Created:
--          by - kayra.UNKNOWN (linux-desktop4.tuni.fi)
...
--
-- Created:
--          by - kaakkola.kaakkola (linux-desktop4.tuni.fi)
--          at - 16:07:43 10/31/20
--
-- Generated by Mentor Graphics' HDL Designer(TM) 2019.3 (Build 4)
--
LIBRARY ieee;
...
ARCHITECTURE struct OF HELLO_LED IS
   ...
   COMPONENT c2_t1_pixel_conf_full
   PORT (
      btn       : IN     std_logic_vector (3 DOWNTO 0);
      sw0       : IN     std_logic ;
   ...
   FOR ALL : c2_t1_pixel_conf_full USE ENTITY alien_game_lib.c2_t1_pixel_conf_full;
