-- VHDL Entity alien_game_lib.right_shifter_overflow.symbol
--
-- Created:
--          by - kaakkola.kaakkola (linux-desktop1.tuni.fi)
--          at - 13:15:36 10/09/20
--
...
ENTITY right_shifter_overflow IS
   PORT( 
...
END right_shifter_overflow ;

--
-- VHDL Architecture alien_game_lib.right_shifter_overflow.struct
--
-- Created:
--          by - kaakkola.kaakkola (linux-desktop1.tuni.fi)
--          at - 13:15:36 10/09/20
...
ARCHITECTURE struct OF right_shifter_overflow IS
...
BEGIN
   ...
   data_out <= dout & dout7 & dout6 & dout5 & dout4 & dout3 & dout2 & dout1;
