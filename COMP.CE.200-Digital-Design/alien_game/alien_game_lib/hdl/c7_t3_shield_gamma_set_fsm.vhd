-- VHDL Entity alien_game_lib.c7_t3_shield_gamma_set.symbol
--
-- Created:
--          by - kaakkola.kaakkola (linux-desktop2.tuni.fi)
--          at - 13:50:10 12/04/20
--
...
ENTITY c7_t3_shield_gamma_set IS
   PORT( 
      clk      : IN     std_logic;
      rst_n    : IN     std_logic;
      rx_rdy   : IN     std_logic;
...
END c7_t3_shield_gamma_set ;

--
-- VHDL Architecture alien_game_lib.c7_t3_shield_gamma_set.fsm
--
-- Created:
--          by - kaakkola.kaakkola (linux-desktop2.tuni.fi)
--          at - 15:19:14 12/04/20
--
-- Generated by Mentor Graphics' HDL Designer(TM) 2019.3 (Build 4)
--
LIBRARY ieee;
...
ARCHITECTURE fsm OF c7_t3_shield_gamma_set IS
   ...
   BEGIN
      ...
      ELSIF (clk'EVENT AND clk = '1') THEN
         ...
         CASE current_state IS
            WHEN s1 => 
               IF (csm_timeout = '1' AND (rx_rdy <= '1')) THEN 
                  lat_cld <= '1';
                  transmit_cld <= '0';
               END IF;
            WHEN latch => 
               sb_cld <= '1';
            WHEN s0 => 
               IF (csm_timeout = '1' AND (counter <= 17)) THEN 
                  transmit_cld <= '1';
                  counter <= counter +1;
               ELSIF (csm_timeout = '1' AND (rx_rdy <= '1' AND counter_row <= 7)) THEN 
                  counter <= 0;
                  counter_row <= counter_row +1;
               ELSIF (csm_timeout = '1' AND (rx_rdy = '1')) THEN 
                  transmit_cld <= '1';
               END IF;
            WHEN s2 => 
               IF (csm_timeout = '1' AND (rx_rdy = '1')) THEN 
