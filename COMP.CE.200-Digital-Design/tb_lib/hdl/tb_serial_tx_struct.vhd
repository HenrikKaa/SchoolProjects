...
ARCHITECTURE struct OF tb_serial_tx IS
   ...
   COMPONENT c7_t2_serial_data_transmit
   PORT (
      bit_in   : IN     std_logic ;
      clk      : IN     std_logic ;
      rst_n    : IN     std_logic ;
   ...
   FOR ALL : c7_t2_serial_data_transmit USE ENTITY alien_game_lib.c7_t2_serial_data_transmit;
...
BEGIN
   ...
   U_0 : c7_t2_serial_data_transmit
      PORT MAP (
         bit_in   => bit_in,
         clk      => clk,
         rst_n    => rst_n,
